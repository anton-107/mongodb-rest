...
module.exports = function (app, config) {
    ...
    var queryToResponse = function (collection, req, res, query, options) {
    ...
    app.get(urlPrefix + '/:db/:collection/:id?', function(req, res) { 
        ...
        connection.connect(dbConnectionStr + '/' + req.params.db, function (err, db) {
            ...
            db.collection(req.params.collection, function(err, collection) {
                ...
                return queryToResponse(collection, req, res, query, options);
            });
                ...
                db.collection(req.params.collection, function(err, collection) {
                    ...
                    collection.insert(
                        ...
                        function(err, docs) {
                            ...
                            res.status(201);
                            var query = {'_id': new BSON.ObjectID(docs[0]._id)};
                            return queryToResponse(collection, req, res, query, options);
                        }
                    );
                });
    ...
    app.put(urlPrefix + '/:db/:collection/:id', function(req, res) {
        ...
        connection.connect(dbConnectionStr + '/' + req.params.db, function (err, db) {
            ...
            db.collection(req.params.collection, function(err, collection) {
                ...
                collection.update(spec, req.body, {}, function(err, docs) {
                    return queryToResponse(collection, req, res, query, {});
                });
            });
        });
    });
    ...
    * Patch
    */
    app.patch(urlPrefix + '/:db/:collection/:id', function(req, res) {
        var spec = {'_id': new BSON.ObjectID(req.params.id)};
        var query = spec;
        ...
        connection.connect(dbConnectionStr + '/' + req.params.db, function (err, db) {
            ...
            db.collection(req.params.collection, function(err, collection) {
                ...
                collection.update(spec, {$set:req.body}, {}, function(err, docs) {
                    return queryToResponse(collection, req, res, query, {});
                });
            });
        });
